...
export type Skill = {
    label: string
    category: SkillCategory // Hex accent color used for chips and glows.
    bg: string // URL of the logo SVG - mostly devicons CDN.
    src: string // When true, the skill is placed on a face of the 3D hero cube.
    onCube?: boolean
}
...
export const SKILLS: readonly Skill[] = [
    ...
    { label: "SAS", category: "language", bg: "#003B7A", src: "/images/programming_logos/sas.svg" },
    ...
    { label: "PuTTY", category: "tool", bg: "#0B1020", src: "/images/programming_logos/putty.svg" },
